    ...
    return (
        <Card className="relative w-full max-w-115 rounded-none border-3 border-black shadow-[8px_8px_0_black] bg-white p-1">
            ...
            <CardHeader className="pb-2">
                ...
                <CardTitle className="font-heading text-2xl tracking-tight">Crie sua conta</CardTitle>
                <CardDescription className="text-sm">Comece a catalogar sua lista agora.</CardDescription>
            </CardHeader>

            <CardContent>
                <form onSubmit={onSubmit} className="flex flex-col gap-4">
                    <div>
                        <label className="block text-[11.5px] font-bold mb-1.5 tracking-wide">Nome</label>
                        <input
                            {...register("name")}
                            type="text"
                        ...
                        />
                        {errors.name && (
                            <p className="text-red text-xs font-semibold mt-1">{errors.name.message}</p>
                        )}
                    </div>
                    ...
                    <div>
                        <label className="block text-[11.5px] font-bold mb-1.5 tracking-wide">Confirmar senha</label>
                        <input
                        ...
                        {errors.confirmPassword && (
                            <p className="text-red text-xs font-semibold mt-1">{errors.confirmPassword.message}</p>
                        )}
                    </div>
            ...
            <CardFooter className="justify-center pt-0">
                <p className="text-[13px] text-graphite">
                    Já tem conta?{" "}
                    <Link href="/login" className="text-red font-bold underline">Entrar</Link>
                </p>
            </CardFooter>
        </Card>
    )
