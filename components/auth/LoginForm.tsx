...
const LoginForm = ({ register, errors, onSubmit, isLoading, errorMessage }: LoginFormProps) => {
    return (
        <Card className="relative w-full max-w-95 rounded-none border-3 border-black shadow-[8px_8px_0_black] bg-white p-1">
